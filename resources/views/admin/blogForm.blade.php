					...
					<div class="col-lg-6">
                        <div class="card">
							...
							<div class="card-body card-block">
								<form action="{{ Route('Blog-Create') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf
                                    ...
                                    <div class="row form-group">
										...
										<div class="col-12 col-md-9"><textarea type="text" class="ckeditor form-control" id="overview" placeholder="Write course overview"
                                            name="blog_description" rows="30" cols="10" required></textarea></div>
									</div>
